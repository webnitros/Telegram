...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            ...
            $properties = array(
                'name' => 'Telegram',
                'description' => 'Default source for files of Telegram',
            ...
            if ($setting = $modx->getObject('modSystemSetting', array('key' => 'telegram_source_default'))) {
